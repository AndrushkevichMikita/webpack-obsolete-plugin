...
describe("method-test", () => {
  ...
  describe("Android firefox 14+", () => {
    it("should pass firefox 14+", () => {
      setUserAgent(
  ...
  describe("IOS Firefox 15", () => {
    it("should pass IOS firefox 15", () => {
      setUserAgent(
        "Mozilla/5.0 (iPhone; CPU iPhone OS 16_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/115.1  Mobile/15E148 Safari/605.1.15"
      );
      expect(
        obsolete([
          'and_chr 114',
